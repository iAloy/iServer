...
all: clean
	@for i in $(ARCH);do echo "Building for $$i ..."; env GOOS=linux GOARCH=$$i go build  --ldflags="-s -w -X 'main.versionStr=${VERSION}' -buildid=" -tags "netgo" -o build/iServer_$$i .; done
	@echo "Done.";
